...
print(dalys_data.iloc[0:101:10,3])#first 100 rows with a step of 10, fourth column
...
print(dalys_data.loc[dalys_data['Entity'] == 'Afghanistan', 'DALYs'])#rows where the heading 'Entity; is 'Afghanistan' and the "DALYs" column
...
plt.figure()
plt.plot(china_year, China_DALYs, 'bo')#a circle plot in blue was used
